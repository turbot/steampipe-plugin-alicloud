	...
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			},
			{
				...
				Transform:   transform.FromGo().Transform(transform.ToBool),
			},
			{
				Name:        "password_active",
				Description: "Indicates whether the password is active, or not.",
				Type:        proto.ColumnType_BOOL,
				Transform:   transform.FromGo().NullIfZero().NullIfEqual("N/A").Transform(transform.ToBool),
			},
			{
				Name:        "mfa_active",
			...
			},
			{
				...
				Type:        proto.ColumnType_TIMESTAMP,
				Transform:   transform.FromGo().NullIfEqual("N/A").NullIfEqual("-"),
			},
			{
