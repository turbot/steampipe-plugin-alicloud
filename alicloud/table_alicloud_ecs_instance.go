...
func tableAlicloudEcsInstance(ctx context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "last_invoked_time", Type: proto.ColumnType_STRING, Description: "The hostname of the instance."},
			...
			{Name: "registration_time", Type: proto.ColumnType_STRING, Description: "The time when the instance was created."},
			...
			{Name: "is_spot", Type: proto.ColumnType_BOOL, Description: "The hostname of the instance."},
			...
			{Name: "machine_id", Type: proto.ColumnType_STRING, Description: "The hostname of the instance."},
