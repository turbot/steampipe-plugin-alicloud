...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"alicloud_ecs_disk_metric_read_ops_daily":            tableAlicloudEcsDiskMetricReadOpsDaily(ctx),
			"alicloud_ecs_disk_metric_write_ops":                 tableAlicloudEcsDiskMetricWriteOps(ctx),
			"alicloud_ecs_disk_metric_write_ops_daily":           tableAlicloudEcsDiskMetricWriteOpsDaily(ctx),
