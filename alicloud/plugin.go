...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"alicloud_ecs_disk_metric_read_ops":                  tableAlicloudEcsDiskMetricReadIops(ctx),
			"alicloud_ecs_disk_metric_read_ops_daily":            tableAlicloudEcsDiskMetricReadIopsDaily(ctx),
			"alicloud_ecs_disk_metric_write_ops":                 tableAlicloudEcsDiskMetricWriteIops(ctx),
			"alicloud_ecs_disk_metric_write_ops_daily":           tableAlicloudEcsDiskMetricWriteIopsDaily(ctx),
