...
Alicloud Monitoring metrics provide data about the performance of your systems. The `alicloud_ecs_disk_metric_write_iops_daily` table provides metric statistics at 24 hour intervals for the most recent 30 days.
